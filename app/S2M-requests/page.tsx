// S2M-requests - Seller Support Request Form
'use client';

import { useState } from 'react';
import { useRouter } from 'next/navigation';
import { Card, Form, Input, Select, Button, Upload, Typography, Divider, message, Alert } from 'antd';
import { Upload as UploadIcon, Send, ArrowLeft, AlertTriangle } from 'lucide-react';
...
const problemCategories = [
  { value: 'product-upload', label: 'Product upload issues' },
  { value: 'payments', label: 'Payments & payouts' },
  { value: 'reviews', label: 'Reviews & ratings' },
  { value: 'account', label: 'Seller account' },
...
export default function S2MRequestsPage() {
  ...
  const handleSubmit = async (values: SupportFormValues) => {
    ...
    try {
      ...
      formData.append('support_center', 'SELLER-SUPPORT-CENTER');
  ...
  return (
    <div className="max-w-3xl mx-auto py-4">
      ...
      {/* Header */}
      <div className="mb-8">
        <Title level={2} className="mb-2!">Seller Support Request</Title>
        <Paragraph type="secondary" className="text-base mb-0!">
          Welcome to the Author Help Center! Get expert guidance, resources, and support for your seller account.
        </Paragraph>
      </div>
      ...
      <Alert
        type="warning"
        message="For Authors Only"
        description="This request form is for Authors who sell items on PackMyCode. If you are a customer looking for product support, please use the Product Support form instead."
        showIcon
      ...
      <Card className="shadow-sm">
        ...
        >
          ...
          <div className="mb-6">
            ...
            {!isLoggedIn && (
              <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg mb-4">
                <Text>Existing seller? Sign in to auto-fill your contact details and save time.</Text>
          ...
          <Form.Item
            ...
            extra={
              <Text type="secondary" className="text-xs">
                Describe your issue in detail. Include any relevant product IDs, order numbers, or screenshots.
              </Text>
            }
          >
            <TextArea
          ...
          <Form.Item
            ...
            extra={<Text type="secondary" className="text-xs">Screenshots or documents that help explain your issue (max 5 files)</Text>}
          >
            <Upload.Dragger
              fileList={fileList}
          ...
          <Form.Item
            ...
            extra={
              <Text type="secondary" className="text-xs">
                Please use the email address associated with your seller account.
              </Text>
            }
          >
