  ...
  return (
    <div className="layout">
      ...
      <div className="content px-2 sm:pb-2" style={{ gridTemplateColumns: 'auto 1fr', height: '100%' }}>
        ...
        {/* Main content area */}
        <main className="main border border-gray-200 rounded-mdxl overflow-hidden shadow-[0_2px_2px_#0000000a,0_8px_8px_-8px_#0000000a] relative z-10" style={{ height: '100%', minHeight: 0 }}>
          {children}
        </main>
      </div>
    </div>
