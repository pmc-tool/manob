...
export default function CartItem({
  ...
  return (
    // align-middle bg-white border-bottom cart-item items mb-4 odd pb-4 position-relative
    <li className="align-middle bg-white border-b border-gray-200 mb-4 pb-4 relative">
      {/* Remove Button - bg-white end-0 fw-medium fz13 position-absolute px-3 py-2 rounded-4 text-muted top-0 border-0 */}
      <button
        type="button"
        className="bg-white absolute right-0 top-0 font-medium text-[13px] px-3 py-2 rounded-2xl text-gray-500 border-0 hover:text-red-500 flex items-center gap-1 cursor-pointer"
        onClick={() => onRemove(id)}
      >
        Remove
      ...
      {/* row g-3 align-items-center justify-content-between */}
      <div className="flex flex-col sm:flex-row gap-3 items-center justify-between">
        ...
        <div className="w-full sm:w-auto">
          ...
          <div className="flex items-center justify-center sm:justify-end">
            {/* Original Price (if on sale) - fw-normal fz19 text-black-50 text-decoration-line-through me-2 */}
            ...
            {/* Current Price - fw-medium fz27 text-thm */}
          ...
          {/* License Select - border-primary-soft bgc-thm8 form-select form-select-sm fw-medium pe-3 ps-2 rounded-3 text-thm */}
