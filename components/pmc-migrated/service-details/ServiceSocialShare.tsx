// Service Social Share component (matching original PMC design)
'use client';

import { useEffect, useState } from 'react';
import { Share2, Heart, X, Twitter, Facebook, Linkedin, Link as LinkIcon } from 'lucide-react';

interface ServiceSocialShareProps {
  shareTitle: string;
...
export default function ServiceSocialShare({
  shareTitle,
  shareDescription,
  totalLikes = 0,
  isLiked = false,
    ...
    <>
      <div className="mb-4 p-3 sm:p-4 relative rounded-lg shadow bg-white">
        <div className="flex items-center">
          {/* Share tip label */}
          <div className="share-tip text-xs uppercase tracking-wider flex items-center font-medium">
            Share
          ...
          <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4 relative">
            ...
            <div className="flex flex-wrap gap-3 justify-center social-share-btns mt-4 mb-3">
              ...
              >
                ...
                <span className="block text-[13px] mt-2">Twitter</span>
              </button>
              ...
              >
                ...
                <span className="block text-[13px] mt-2">Facebook</span>
              </button>
              ...
              >
                ...
                <span className="block text-[13px] mt-2">LinkedIn</span>
              </button>
              ...
              >
                ...
                <span className="block text-[13px] mt-2">WhatsApp</span>
              </button>
              ...
              >
                ...
                <span className="block text-[13px] mt-2">{copied ? 'Copied!' : 'Copy Link'}</span>
              </button>
            </div>
          </div>
        </div>
