...
export default function BlogHeroCard({ post }: BlogHeroCardProps) {
  return (
    <div className="blog-hero-card card mb-5 border-0 shadow rounded-lg overflow-hidden">
      <div className="grid grid-cols-1 lg:grid-cols-12">
        {/* Image Section */}
        <div className="lg:col-span-8 relative">
          <div className="blog-hero-image position-relative overflow-hidden">
        ...
        <div className="lg:col-span-4 flex flex-col">
          <div className="card-body p-6 flex flex-col h-full">
            <h3 className="blog-card-title fw-semibold fz22 mb-4">
              <Link href={`/blog/${post.slug || post.id}`} className="text-dark hover:text-primary">
                {post.title}
              </Link>
            </h3>
            <p className="card-text text-gray-600 fz15 line-clamp-4 flex-grow">
